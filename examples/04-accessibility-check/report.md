...
_(input.html의 코드를 Claude에게 붙여넣기)_
...
```html
✅ <label for="name-input">이름</label> <input type="text" id="name-input" name="name" placeholder="이름" required />
```
...
<html lang="ko">
  ...
  <body>
    ...
    <!-- ✅ 충분한 터치 영역 -->
    <button type="button" class="close-button" aria-label="닫기">✕</button>
